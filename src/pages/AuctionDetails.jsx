                    ...
                    {topBids.length === 0 ? (
                      ...
                      <div className="space-y-3 max-h-96 overflow-y-auto">
                        {topBids.map((bid, idx) => (
                          ...
                          >
                            <div>
                              <p className="font-semibold text-white">{bid.bidder?.name || 'Anonymous'}</p>
              ...
              <form onSubmit={handlePlaceBid} className="space-y-4">
                <div>
                  ...
                  <p className="mt-1 text-xs text-gray-400">
                    Increment: ₹{auction.bidIncrement.toLocaleString()}
                  </p>
                </div>
                <button
                  type="submit"
                      ...
                      <>
                        {autoBidStatus && !autoBidStatus.isActive && autoBidStatus.stopReason && (
                          <div className="w-full text-center bg-orange-700 rounded-xl p-4 shadow-inner border-2 border-orange-500 flex flex-col items-center mb-4 mt-2">
                            <span className="text-lg font-semibold text-white">🤖 Auto-Bid Stopped</span>
                            <span className="block text-yellow-300 mt-2 text-base">
                              ...
                              {!["highest-bidder", "max-amount", "auction-ended"].includes(autoBidStatus.stopReason)
                                && "Auto-bidding is no longer active."}
                            </span>
                          </div>
                        )}
