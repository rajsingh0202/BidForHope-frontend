...
const Login = () => {
  // All useState INSIDE the component!
  ...
  // Step 1: Send OTP after validating credentials
  ...
  const handleVerifyOtp = async (e) => {
    ...
    try {
      const { data } = await loginVerifyOtp({
      ...
      <div className="max-w-md w-full bg-gray-900 rounded-2xl shadow-2xl p-8 border border-gray-800">
        ...
        {!otpSent ? (
          <form onSubmit={handleSendOtp} className="space-y-6">
            ...
            >
              {loading ? 'Sending OTP...' : 'Sign In & Get OTP'}
            </button>
          </form>
        ) : (
          <form onSubmit={handleVerifyOtp} className="space-y-6">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 border border-gray-700 rounded-lg focus:ring-2 focus:ring-green-600 focus:border-green-600 bg-black text-white placeholder-gray-500 transition"
            ...
            <button
              ...
              className="w-full bg-green-700 hover:bg-green-600 text-white font-semibold py-3 px-4 rounded-lg shadow-lg transition duration-200 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed"
            >
